...
// Lazy-loaded provider factories (dynamic imports for performance)
type ProviderFactory = (options?: any) => any
const PROVIDER_IMPORTS: Record<string, () => Promise<ProviderFactory>> = {
  ...
  "@gitlab/gitlab-ai-provider": () =>
    import("@gitlab/gitlab-ai-provider").then((m) => m.createGitLab),
  "./sdk/copilot": () => import("./sdk/copilot").then((m) => m.createOpenaiCompatible),
}
...
// Lazy import helper
async function getProviderFactory(npm: string): Promise<ProviderFactory> {
  const cached = providerCache.get(npm)
  if (cached) return cached

  const importer = PROVIDER_IMPORTS[npm]
  if (!importer) throw new Error(`Unknown provider: ${npm}`)

  const fn = await importer()
  providerCache.set(npm, fn)
  return fn
}

// Static imports for non-provider dependencies
...
export namespace Provider {
  ...
  // Lazy provider factory map - providers loaded on first use
  const BUNDLED_PROVIDERS: Record<string, () => Promise<(options: any) => SDK>> = {
    "@ai-sdk/amazon-bedrock": () => getProviderFactory("@ai-sdk/amazon-bedrock"),
    "@ai-sdk/anthropic": () => getProviderFactory("@ai-sdk/anthropic"),
    "@ai-sdk/azure": () => getProviderFactory("@ai-sdk/azure"),
    "@ai-sdk/google": () => getProviderFactory("@ai-sdk/google"),
    "@ai-sdk/google-vertex": () => getProviderFactory("@ai-sdk/google-vertex"),
    "@ai-sdk/google-vertex/anthropic": () => getProviderFactory("@ai-sdk/google-vertex/anthropic"),
    "@ai-sdk/openai": () => getProviderFactory("@ai-sdk/openai"),
    "@ai-sdk/openai-compatible": () => getProviderFactory("@ai-sdk/openai-compatible"),
    "@openrouter/ai-sdk-provider": () => getProviderFactory("@openrouter/ai-sdk-provider"),
    "@ai-sdk/xai": () => getProviderFactory("@ai-sdk/xai"),
    "@ai-sdk/mistral": () => getProviderFactory("@ai-sdk/mistral"),
    "@ai-sdk/groq": () => getProviderFactory("@ai-sdk/groq"),
    "@ai-sdk/deepinfra": () => getProviderFactory("@ai-sdk/deepinfra"),
    "@ai-sdk/cerebras": () => getProviderFactory("@ai-sdk/cerebras"),
    "@ai-sdk/cohere": () => getProviderFactory("@ai-sdk/cohere"),
    "@ai-sdk/gateway": () => getProviderFactory("@ai-sdk/gateway"),
    "@ai-sdk/togetherai": () => getProviderFactory("@ai-sdk/togetherai"),
    "@ai-sdk/perplexity": () => getProviderFactory("@ai-sdk/perplexity"),
    "@ai-sdk/vercel": () => getProviderFactory("@ai-sdk/vercel"),
    "@gitlab/gitlab-ai-provider": () => getProviderFactory("@gitlab/gitlab-ai-provider"),
    "@ai-sdk/github-copilot": () => getProviderFactory("./sdk/copilot"),
  }
  ...
  async function getSDK(model: Model) {
    try {
      ...
      if (bundledLoader) {
        ...
        const createFn = await bundledLoader()
        const loaded = createFn({
